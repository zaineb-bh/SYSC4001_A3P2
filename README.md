...
./part2a 2 5      # minimum valid case
./part2a 3 10    # more exams
./part2a 4 5      # more TAs
./part2a 1 5      # If less than 2 TAs, program forces there to be 2 TAs. 
./part2a           # no number of processes/TAs passed, error
